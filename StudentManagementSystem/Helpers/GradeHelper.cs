    ...
    public void GiveGrades(long teacherTckn)
{
    ...
    {
        _gradeRepository.AddOrUpdateGrade(selectedHomework.HomeworkId, selectedStudent.StudentId, gradeVal, feedback);
    ...
    public void UpdateGrade(long teacherTckn)
    {
        ...
        {
            _gradeRepository.AddOrUpdateGrade(selectedHw.HomeworkId, selectedGrade.StudentId, parsed, newFeedback);
